"""Definitions of colour names."""
# pylint: disable=too-many-lines

# A basic palette of colours.
#
# This comes from Xorg's rgb.txt.
#
# Duplicate entries have been removed by the simple method of taking the first
# occurrence in each case.
name_to_hex = {
    "Black":             '#000000',
    "Red":               '#800000',
    "Green":             '#008000',
...
# This comes from Vim's source code.
_vim_rgb = {
    (255, 250, 250): 'snow',
...
name_to_number = {name: i for i, name in enumerate(name_to_hex)}
for (r, g, b), name in _vim_rgb.items():
    rgb = f'#{r:02x}{g:02x}{b:02x}'
    name = name.lower()
    name_to_hex[name] = rgb
